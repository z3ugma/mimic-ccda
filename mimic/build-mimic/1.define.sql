...
DROP TABLE IF EXISTS mimic.ADMISSIONS;
CREATE TABLE mimic.ADMISSIONS (	-- rows=58976
...
LOAD DATA INFILE '/mimic_data/ADMISSIONS.csv' INTO TABLE mimic.ADMISSIONS
...
DROP TABLE IF EXISTS mimic.CALLOUT;
CREATE TABLE mimic.CALLOUT (	-- rows=34499
   ROW_ID SMALLINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/CALLOUT.csv' INTO TABLE mimic.CALLOUT
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.CAREGIVERS;
CREATE TABLE mimic.CAREGIVERS (	-- rows=7567
   ROW_ID SMALLINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/CAREGIVERS.csv' INTO TABLE mimic.CAREGIVERS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.CHARTEVENTS;
CREATE TABLE mimic.CHARTEVENTS (	-- rows=263201375
...
LOAD DATA INFILE '/mimic_data/CHARTEVENTS.csv' INTO TABLE mimic.CHARTEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.CPTEVENTS;
CREATE TABLE mimic.CPTEVENTS (	-- rows=573146
...
LOAD DATA INFILE '/mimic_data/CPTEVENTS.csv' INTO TABLE mimic.CPTEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.DATETIMEEVENTS;
CREATE TABLE mimic.DATETIMEEVENTS (	-- rows=4486049
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED,
   ICUSTAY_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/DATETIMEEVENTS.csv' INTO TABLE mimic.DATETIMEEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.DIAGNOSES_ICD;
CREATE TABLE mimic.DIAGNOSES_ICD (	-- rows=651047
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/DIAGNOSES_ICD.csv' INTO TABLE mimic.DIAGNOSES_ICD
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.DRGCODES;
CREATE TABLE mimic.DRGCODES (	-- rows=125557
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/DRGCODES.csv' INTO TABLE mimic.DRGCODES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.D_CPT;
CREATE TABLE mimic.D_CPT (	-- rows=134
...
LOAD DATA INFILE '/mimic_data/D_CPT.csv' INTO TABLE mimic.D_CPT
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.D_ICD_DIAGNOSES;
CREATE TABLE mimic.D_ICD_DIAGNOSES (	-- rows=14567
   ROW_ID SMALLINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/D_ICD_DIAGNOSES.csv' INTO TABLE mimic.D_ICD_DIAGNOSES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.D_ICD_PROCEDURES;
CREATE TABLE mimic.D_ICD_PROCEDURES (	-- rows=3882
   ROW_ID SMALLINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/D_ICD_PROCEDURES.csv' INTO TABLE mimic.D_ICD_PROCEDURES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@ICD9_CODE,@SHORT_TITLE,@LONG_TITLE)
...
DROP TABLE IF EXISTS mimic.D_ITEMS;
CREATE TABLE mimic.D_ITEMS (	-- rows=12478
   ROW_ID SMALLINT UNSIGNED NOT NULL,
   ITEMID MEDIUMINT UNSIGNED NOT NULL,
   LABEL TEXT,	-- max=95
...
LOAD DATA INFILE '/mimic_data/D_ITEMS.csv' INTO TABLE mimic.D_ITEMS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.D_LABITEMS;
CREATE TABLE mimic.D_LABITEMS (	-- rows=755
   ROW_ID SMALLINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/D_LABITEMS.csv' INTO TABLE mimic.D_LABITEMS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.ICUSTAYS;
CREATE TABLE mimic.ICUSTAYS (	-- rows=61532
   ROW_ID SMALLINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/ICUSTAYS.csv' INTO TABLE mimic.ICUSTAYS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.INPUTEVENTS_CV;
CREATE TABLE mimic.INPUTEVENTS_CV (	-- rows=17528894
   ROW_ID INT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/INPUTEVENTS_CV.csv' INTO TABLE mimic.INPUTEVENTS_CV
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.INPUTEVENTS_MV;
CREATE TABLE mimic.INPUTEVENTS_MV (	-- rows=3618991
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
   ICUSTAY_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/INPUTEVENTS_MV.csv' INTO TABLE mimic.INPUTEVENTS_MV
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.LABEVENTS;
CREATE TABLE mimic.LABEVENTS (	-- rows=27872575
   ROW_ID INT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED,
   ITEMID SMALLINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/LABEVENTS.csv' INTO TABLE mimic.LABEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.MICROBIOLOGYEVENTS;
CREATE TABLE mimic.MICROBIOLOGYEVENTS (	-- rows=328446
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/MICROBIOLOGYEVENTS.csv' INTO TABLE mimic.MICROBIOLOGYEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.NOTEEVENTS;
CREATE TABLE mimic.NOTEEVENTS (	-- rows=2078705
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/NOTEEVENTS.csv' INTO TABLE mimic.NOTEEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.OUTPUTEVENTS;
CREATE TABLE mimic.OUTPUTEVENTS (	-- rows=4349339
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED,
   ICUSTAY_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/OUTPUTEVENTS.csv' INTO TABLE mimic.OUTPUTEVENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.PATIENTS;
CREATE TABLE mimic.PATIENTS (	-- rows=46520
   ROW_ID SMALLINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/PATIENTS.csv' INTO TABLE mimic.PATIENTS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.PRESCRIPTIONS;
CREATE TABLE mimic.PRESCRIPTIONS (	-- rows=4156848
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
   ICUSTAY_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/PRESCRIPTIONS.csv' INTO TABLE mimic.PRESCRIPTIONS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.PROCEDUREEVENTS_MV;
CREATE TABLE mimic.PROCEDUREEVENTS_MV (	-- rows=258066
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
   ICUSTAY_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/PROCEDUREEVENTS_MV.csv' INTO TABLE mimic.PROCEDUREEVENTS_MV
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.PROCEDURES_ICD;
CREATE TABLE mimic.PROCEDURES_ICD (	-- rows=240095
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/PROCEDURES_ICD.csv' INTO TABLE mimic.PROCEDURES_ICD
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
   (@ROW_ID,@SUBJECT_ID,@HADM_ID,@SEQ_NUM,@ICD9_CODE)
...
DROP TABLE IF EXISTS mimic.SERVICES;
CREATE TABLE mimic.SERVICES (	-- rows=73343
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
...
LOAD DATA INFILE '/mimic_data/SERVICES.csv' INTO TABLE mimic.SERVICES
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
...
DROP TABLE IF EXISTS mimic.TRANSFERS;
CREATE TABLE mimic.TRANSFERS (	-- rows=261897
   ROW_ID MEDIUMINT UNSIGNED NOT NULL,
   SUBJECT_ID MEDIUMINT UNSIGNED NOT NULL,
   HADM_ID MEDIUMINT UNSIGNED NOT NULL,
   ICUSTAY_ID MEDIUMINT UNSIGNED,
...
LOAD DATA INFILE '/mimic_data/TRANSFERS.csv' INTO TABLE mimic.TRANSFERS
   FIELDS TERMINATED BY ',' ESCAPED BY '\\' OPTIONALLY ENCLOSED BY '"'
   LINES TERMINATED BY '\n'
   IGNORE 1 LINES
